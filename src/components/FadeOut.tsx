...
export default function FadeOut() {
	...
	return (
		...
		>
			...
			<div className="bg-gradient-to-b shadow-2xl from-primaryLight to-primaryLighter z-20  absolute py-6 pr-2 lg:pr-8  pl-4 lg:pl-8 md:py-12 bottom-0 translate-y-[62%] lg:translate-y-[10%] left-1/2 -translate-x-1/2 w-[80%] max-w-[320px] md:max-w-[660px]  rounded-[20px] lg:rounded-[40px] ">
				<div className=" flex justify-between items-center">
					<div className="space-y-1">
						<div className="text-[0.6rem] leading-[12px]   md:text-xl lg:text-2xl  font-bold text-secondary capitalize">
							oumaima <br /> smahi
						</div>
						<div className="xs:text-[0.5rem]  text-[0.4rem]  text-secondary  font-normal md:text-base  capitalize">
							full stack developer
						</div>
					</div>
					<AnimatedButton />
				</div>
				<div className="absolute rounded-full bg-gradient-to-b from-primaryLighter to-white xs:size-[135px]  size-[118px]  md:size-[280px] bottom-[7px] lg:bottom-[10%]  left-1/2 -translate-x-1/2"></div>
				<div
