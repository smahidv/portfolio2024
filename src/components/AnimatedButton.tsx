	...
	return (
		<div ref={scope}>
			<button
				...
				className="relative inline-block bg-secondary hover:bg-white hover:text-secondary hover:border hover:border-secondary shadow-2xl text-white  md:text-sm text-[0.4rem] mobi:text-[0.52rem] font-semibold md:px-6 px-2 xs:px-3  md:py-3 rounded-2xl"
			>
